 ...
 * 
 * Этот файл содержит компонент личного кабинета с вкладками для:
 * - Просмотра сгенерированных логотипов
 * - Просмотра сгенерированных брендбуков
 * - Переходов на страницы с конкретными элементами */
            ...
            <div className="tab-content">
              ...
              {isLoadingBrandbooks ? (
                ...
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={() => router.push('/brandbook-generator')}
                    className="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors"
                  >
                    Создать брендбук
                  </button>
